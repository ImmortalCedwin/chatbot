class ai_resource:
  ...
  def generate_dmc_syllabus_prompt(self):
    return f"""You are a chatbot for the college DMC in Goa. Answer the question by using the information below.
